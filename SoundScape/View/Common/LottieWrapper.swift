...
class LottieWrapper {
    ...
    func createLottieAnimationView(lottieType: LottieJSONType,
                                   frame: CGRect) -> LottieAnimationView {
        // Lottie 4.x uses LottieAnimationView instead of AnimationView
        let animationView = LottieAnimationView(name: lottieType.name)
